...
class Dashboard_model extends CI_Model
{
    ...
    function lokasi()
    {
        $this->db->select('nama_lokasi,sum(jumlah) as pagu');
        $this->db->group_by('kode_lokasi');
        $query = $this->db->get('v_dashboard');
        return $query->result();
    }

    function pagu_realisasi_kegiatan()
    {
    ...
    function pagu_realisasi_lokasi()
    {
    ...
    function pagu_realisasi_detail()
    {
        $this->db->select('b.nama_satker,a.nama_kegiatan,
        a.nama_kro,
        ...
        $this->db->group_by('a.kode_satker,a.kode_kro,a.kode_kegiatan');
        return $this->db->get('v_dashboard')->result();
    }
}
