...
class Akun_model extends CI_Model
{
    ...
    function json()
    {
        ...
        // $this->datatables->from('zx_tbl_user');
        // $this->datatables->add_column('is_aktif', '$1', 'rename_string_is_aktif(is_aktif)');
        // //add this line for join
        // $this->datatables->join('zx_tbl_user_level', 'zx_tbl_user.id_user_level = zx_tbl_user_level.id_user_level');
        ...
        $this->datatables->add_column('is_aktif', '$1', 'rename_string_is_aktif(is_aktif)');
        //add this line for join
        //$this->datatables->join('zx_tbl_user_level', 'zx_v_login.id_user_level = zx_v_login_level.id_user_level');
