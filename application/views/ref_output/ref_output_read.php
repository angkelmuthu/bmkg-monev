...
<div class="row">
    <div class="col-xl-12">
	    ...
	    <tr><td>Nama Kro</td><td><?php echo $nama_kro; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('ref_output') ?>" class="btn btn-primary waves-effect waves-themed">Kembali</a></td></tr>
	</table>
</div>
</div>
