<form method="post" id="form" >
    ...
    <input type="hidden" name="kode_satker" id="kode_satker" value="<?php echo $kode_satker ?>">
	...
	<table class="table table-sm table-bordered table-hover table-striped" id="dt-basic-example" >
		...
		<td> <input <?php if(!empty($bulan[1])){ echo "readonly"; } ?> type="text" name="nominal_kontrak_jan" id="nominal_kontrak_jan" value="<?php echo $nominal_kontrak_januari ?>" class="form-control" onKeyup="total_nominal('jan',this.value)">
		...
		<td> <input <?php if(!empty($bulan[1])){ echo "readonly"; } ?> type="text" name="anggaran_jan" id="anggaran_jan" value="<?php echo $ang_januari ?>" class="form-control" onKeyup="total_ang('jan',this.value)" readonly>
		     <input type="hidden" name="anggaran_jan_temp" id="anggaran_jan_temp" value="<?php echo $ang_januari ?>" ></td>
		
		<td> <input <?php if(!empty($bulan[1])){ echo "readonly"; } ?> type="text" name="fisik_jan" id="fisik_jan" value="<?php echo $fisik_januari ?>" class="form-control" onKeyup="total_fis('jan',this.value)" >
		...
		<td> <input type="text" <?php if(!empty($bulan[2])){ echo "readonly"; } ?> name="nominal_kontrak_feb" id="nominal_kontrak_feb" value="<?php echo $nominal_kontrak_februari ?>" class="form-control" onKeyup="total_nominal('feb',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[2])){ echo "readonly"; } ?> name="anggaran_feb" id="anggaran_feb" value="<?php echo $ang_februari ?>" class="form-control" onChange="total_ang('feb',this.value)" readonly>
		<input type="hidden" name="anggaran_feb_temp" id="anggaran_feb_temp" value="<?php echo $ang_februari ?>" ></td>
		<td> <input type="text" <?php if(!empty($bulan[2])){ echo "readonly"; } ?> name="fisik_feb" id="fisik_feb" value="<?php echo $fisik_februari ?>" class="form-control" onKeyup="total_fis('feb',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[3])){ echo "readonly"; } ?> name="nominal_kontrak_mar" id="nominal_kontrak_mar" value="<?php echo $nominal_kontrak_maret ?>" class="form-control" onKeyup="total_nominal('mar',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[3])){ echo "readonly"; } ?> name="anggaran_mar" id="anggaran_mar" value="<?php echo $ang_maret ?>" class="form-control" onChange="total_ang('mar',this.value)" readonly>
		<input type="hidden" name="anggaran_mar_temp" id="anggaran_mar_temp" value="<?php echo $ang_maret ?>" ></td>
		<td> <input type="text" <?php if(!empty($bulan[3])){ echo "readonly"; } ?> name="fisik_mar" id="fisik_mar" value="<?php echo $fisik_maret ?>" class="form-control" onKeyup="total_fis('mar',this.value)">
		...
		<tr>
		<td>April</td>
		<!--<td> <input type="text" <?php if(!empty($bulan[4])){ echo "readonly"; } ?> name="tarik_apr" id="tarik_apr" value="<?php echo $april ?>" class="form-control" readonly></td>
		<td> <input type="text" <?php if(!empty($bulan[4])){ echo "readonly"; } ?> name="nominal_kontrak_apr" id="nominal_kontrak_apr" value="<?php echo $nominal_kontrak_april ?>" class="form-control" onKeyup="total_nominal('apr',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[4])){ echo "readonly"; } ?> name="anggaran_apr" id="anggaran_apr" value="<?php echo $ang_april ?>" class="form-control" onChange="total_ang('apr',this.value)" readonly>
		<input type="hidden" name="anggaran_apr_temp" id="anggaran_apr_temp" value="<?php echo $ang_april ?>" ></td>
		<td> <input type="text" <?php if(!empty($bulan[4])){ echo "readonly"; } ?> name="fisik_apr" id="fisik_apr" value="<?php echo $fisik_april ?>" class="form-control" onKeyup="total_fis('apr',this.value)">
		...
		<tr>
		<td>Mei</td>
		<!--<td> <input type="text" <?php if(!empty($bulan[5])){ echo "readonly"; } ?> name="tarik_mei" id="tarik_mei" value="<?php echo $mei ?>" class="form-control" readonly></td>
		<td> <input type="text" <?php if(!empty($bulan[5])){ echo "readonly"; } ?> name="nominal_kontrak_mei" id="nominal_kontrak_mei" value="<?php echo $nominal_kontrak_mei ?>" class="form-control" onKeyup="total_nominal('mei',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[5])){ echo "readonly"; } ?> name="anggaran_mei" id="anggaran_mei" value="<?php echo $ang_mei ?>" class="form-control" onChange="total_ang('mei',this.value)" readonly>
		<input type="hidden" name="anggaran_mei_temp" id="anggaran_mei_temp" value="<?php echo $ang_mei ?>" ></td>
		<td> <input type="text" <?php if(!empty($bulan[5])){ echo "readonly"; } ?> name="fisik_mei" id="fisik_mei" value="<?php echo $fisik_mei ?>" class="form-control" onKeyup="total_fis('mei',this.value)">
		...
		<tr>
		<td>Juni</td>
		<!--<td> <input type="text" <?php if(!empty($bulan[6])){ echo "readonly"; } ?> name="tarik_jun" id="tarik_jun" value="<?php echo $juni ?>" class="form-control" readonly></td>
		<td> <input type="text" <?php if(!empty($bulan[6])){ echo "readonly"; } ?> name="nominal_kontrak_jun" id="nominal_kontrak_jun" value="<?php echo $nominal_kontrak_juni ?>" class="form-control" onKeyup="total_nominal('jun',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[6])){ echo "readonly"; } ?> name="anggaran_jun" id="anggaran_jun" value="<?php echo $ang_juni ?>" class="form-control" onChange="total_ang('jun',this.value)" readonly>
		<input type="hidden" name="anggaran_jun_temp" id="anggaran_jun_temp" value="<?php echo $ang_juni ?>" ></td>
		<td> <input type="text" <?php if(!empty($bulan[6])){ echo "readonly"; } ?> name="fisik_jun" id="fisik_jun" value="<?php echo $fisik_juni ?>" class="form-control" onKeyup="total_fis('jun',this.value)">
		...
		<tr>
		<td>Juli</td>
		<!--<td> <input type="text" <?php if(!empty($bulan[7])){ echo "readonly"; } ?> name="tarik_jul" id="tarik_jul" value="<?php echo $juli ?>" class="form-control" readonly></td>
		<td> <input type="text" <?php if(!empty($bulan[7])){ echo "readonly"; } ?> name="nominal_kontrak_jul" id="nominal_kontrak_jul" value="<?php echo $nominal_kontrak_juli ?>" class="form-control" onKeyup="total_nominal('jul',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[7])){ echo "readonly"; } ?> name="anggaran_jul" id="anggaran_jul" value="<?php echo $ang_juli ?>" class="form-control" onChange="total_ang('jul',this.value)" readonly>
		<input type="hidden" name="anggaran_jul_temp" id="anggaran_jul_temp" value="<?php echo $ang_juli ?>" ></td>
		<td> <input type="text" <?php if(!empty($bulan[7])){ echo "readonly"; } ?> name="fisik_jul" id="fisik_jul" value="<?php echo $fisik_juli ?>" class="form-control" onKeyup="total_fis('jul',this.value)">
		...
		<tr>
		<td>Agustus</td>
		<!--<td> <input type="text" <?php if(!empty($bulan[8])){ echo "readonly"; } ?> name="tarik_agu" id="tarik_agu" value="<?php echo $agustus ?>" class="form-control" readonly></td>
		<td> <input type="text" <?php if(!empty($bulan[8])){ echo "readonly"; } ?> name="nominal_kontrak_agu" id="nominal_kontrak_agu" value="<?php echo $nominal_kontrak_agustus ?>" class="form-control" onKeyup="total_nominal('agu',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[8])){ echo "readonly"; } ?> name="anggaran_agu" id="anggaran_agu" value="<?php echo $ang_agustus ?>" class="form-control" onChange="total_ang('agu',this.value)" readonly>
		<input type="hidden" name="anggaran_agu_temp" id="anggaran_agu_temp" value="<?php echo $ang_agustus ?>" ></td>
		<td> <input type="text" <?php if(!empty($bulan[8])){ echo "readonly"; } ?> name="fisik_agu" id="fisik_agu" value="<?php echo $fisik_agustus ?>" class="form-control" onKeyup="total_fis('agu',this.value)">
		...
		<tr>
		<td>September</td>
		<!--<td> <input type="text" <?php if(!empty($bulan[9])){ echo "readonly"; } ?> name="tarik_sep" id="tarik_sep" value="<?php echo $september ?>" class="form-control" readonly></td>
		<td> <input type="text" <?php if(!empty($bulan[9])){ echo "readonly"; } ?> name="nominal_kontrak_sep" id="nominal_kontrak_sep" value="<?php echo $nominal_kontrak_september  ?>" class="form-control" onKeyup="total_nominal('sep',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[9])){ echo "readonly"; } ?> name="anggaran_sep" id="anggaran_sep" value="<?php echo $ang_september ?>" class="form-control" onChange="total_ang('sep',this.value)" readonly>
		<input type="hidden" name="anggaran_sep_temp" id="anggaran_sep_temp" value="<?php echo $ang_september ?>" ></td>
		<td> <input type="text" <?php if(!empty($bulan[9])){ echo "readonly"; } ?> name="fisik_sep" id="fisik_sep" value="<?php echo $fisik_september ?>" class="form-control" onKeyup="total_fis('sep',this.value)">
		...
		<tr>
		<td>Oktober</td>
		<!--<td> <input type="text" <?php if(!empty($bulan[10])){ echo "readonly"; } ?> name="tarik_okt" id="tarik_okt" value="<?php echo $oktober ?>" class="form-control" readonly></td>
		<td> <input type="text" <?php if(!empty($bulan[10])){ echo "readonly"; } ?> name="nominal_kontrak_okt" id="nominal_kontrak_okt" value="<?php echo $nominal_kontrak_oktober ?>" class="form-control" onKeyup="total_nominal('okt',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[10])){ echo "readonly"; } ?> name="anggaran_okt" id="anggaran_okt" value="<?php echo $ang_oktober ?>" class="form-control" onChange="total_ang('okt',this.value)" readonly>
		<input type="hidden" name="anggaran_okt_temp" id="anggaran_okt_temp" value="<?php echo $ang_oktober ?>" ></td>
		<td> <input type="text" <?php if(!empty($bulan[10])){ echo "readonly"; } ?> name="fisik_okt" id="fisik_okt" value="<?php echo $fisik_oktober ?>" class="form-control" onKeyup="total_fis('okt',this.value)">
		...
		<tr>
		<td>November</td>
		<!--<td> <input type="text" <?php if(!empty($bulan[11])){ echo "readonly"; } ?> name="tarik_nov" id="tarik_nov" value="<?php echo $november ?>" class="form-control" readonly></td>
		<td> <input type="text" <?php if(!empty($bulan[11])){ echo "readonly"; } ?> name="nominal_kontrak_nov" id="nominal_kontrak_nov" value="<?php echo $nominal_kontrak_november ?>" class="form-control" onKeyup="total_nominal('nov',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[11])){ echo "readonly"; } ?> name="anggaran_nov" id="anggaran_nov" value="<?php echo $ang_november ?>" class="form-control" onChange="total_ang('nov',this.value)" readonly>
		<input type="hidden" name="anggaran_nov_temp" id="anggaran_nov_temp" value="<?php echo $ang_februari ?>" ></td>
		<td> <input type="text" <?php if(!empty($bulan[11])){ echo "readonly"; } ?> name="fisik_nov" id="fisik_nov" value="<?php echo $fisik_november ?>" class="form-control" onKeyup="total_fis('nov',this.value)">
		...
		<tr>
		<td>Desember</td>
		<!--<td> <input type="text" <?php if(!empty($bulan[12])){ echo "readonly"; } ?> name="tarik_des" id="tarik_des" value="<?php echo $desember ?>" class="form-control" readonly></td>
		<td> <input type="text" <?php if(!empty($bulan[12])){ echo "readonly"; } ?> name="nominal_kontrak_des" id="nominal_kontrak_des" value="<?php echo $nominal_kontrak_desember ?>" class="form-control" onKeyup="total_nominal('des',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[12])){ echo "readonly"; } ?> name="anggaran_des" id="anggaran_des" value="<?php echo $ang_desember ?>" class="form-control" onChange="total_ang('des',this.value)" readonly>
		<input type="hidden" name="anggaran_des_temp" id="anggaran_des_temp" value="<?php echo $ang_desember ?>" ></td>
		<td> <input type="text" <?php if(!empty($bulan[12])){ echo "readonly"; } ?> name="fisik_des" id="fisik_des" value="<?php echo $fisik_desember ?>" class="form-control" onKeyup="total_fis('des',this.value)">
		...
		<tr>
		<td>Total</td>
		<!--<td> <input type="text" name="total_tarik" id="total_tarik" value="<?php echo $januari+$februari+$maret+$april+$mei+$juni+$juli+$agustus+$september+$oktober+$november+$desember ?>" class="form-control" readonly></td>
		<td> <input type="text" name="total_nominal_kontrak" id="total_nominal_kontrak" value="<?php echo $nominal_kontrak_januari+$nominal_kontrak_februari+$nominal_kontrak_maret+$nominal_kontrak_april+$nominal_kontrak_mei+$nominal_kontrak_juni+$nominal_kontrak_juli+$nominal_kontrak_agustus+$nominal_kontrak_september+$nominal_kontrak_oktober+$nominal_kontrak_november+$nominal_kontrak_desember ?>" class="form-control" readonly></td>-->
		<td> </td>
		<td> </td>
		<td> <input type="text" name="total_anggaran" id="total_anggaran" value="<?php echo $ang_januari+$ang_februari+$ang_maret+$ang_april+$ang_mei+$ang_juni+$ang_juli+$ang_agustus+$ang_september+$ang_oktober+$ang_november+$ang_desember ?>" class="form-control" readonly></td>
    ...
    $(document).ready(function() {
		...
		//	totalawal= $("#total_anggaran").val();
			...
			//pagu= $("#pagu").val();
				...
				$.ajax({
					type: 'POST',
					url: "<?php echo base_url(); ?>pok/update_realisasi_fisik",
					data: data,
					cache: false,
					success: function(data) {
						$('#tampil').load("<?php echo base_url(); ?>pok/pok_data_realisasi_fisik/<?php echo $pok ?>");
