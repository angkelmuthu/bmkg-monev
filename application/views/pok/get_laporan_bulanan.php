...
<div>
    ...
    <table id="dt-basic-example" border="1" style="border-collapse: collapse;" class="table table-sm table-bordered table-hover table-striped" style="font-family: Arial, Helvetica, sans-serif;">
