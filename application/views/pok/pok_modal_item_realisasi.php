<form method="post" id="form" >
	...
	<table class="table table-sm table-bordered table-hover table-striped" id="dt-basic-example" >
		...
		<td> <input <?php if(!empty($bulan[1])){ echo "readonly"; } ?> type="text" name="anggaran_jan" id="anggaran_jan" value="<?php echo $ang_januari ?>" class="form-control" onKeyup="total_ang('jan',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[2])){ echo "readonly"; } ?> name="anggaran_feb" id="anggaran_feb" value="<?php echo $ang_februari ?>" class="form-control" onChange="total_ang('feb',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[3])){ echo "readonly"; } ?> name="anggaran_mar" id="anggaran_mar" value="<?php echo $ang_maret ?>" class="form-control" onChange="total_ang('mar',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[4])){ echo "readonly"; } ?> name="anggaran_apr" id="anggaran_apr" value="<?php echo $ang_april ?>" class="form-control" onChange="total_ang('apr',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[5])){ echo "readonly"; } ?> name="anggaran_mei" id="anggaran_mei" value="<?php echo $ang_mei ?>" class="form-control" onChange="total_ang('mei',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[6])){ echo "readonly"; } ?> name="anggaran_jun" id="anggaran_jun" value="<?php echo $ang_juni ?>" class="form-control" onChange="total_ang('jun',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[7])){ echo "readonly"; } ?> name="anggaran_jul" id="anggaran_jul" value="<?php echo $ang_juli ?>" class="form-control" onChange="total_ang('jul',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[8])){ echo "readonly"; } ?> name="anggaran_agu" id="anggaran_agu" value="<?php echo $ang_agustus ?>" class="form-control" onChange="total_ang('agu',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[9])){ echo "readonly"; } ?> name="anggaran_sep" id="anggaran_sep" value="<?php echo $ang_september ?>" class="form-control" onChange="total_ang('sep',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[10])){ echo "readonly"; } ?> name="anggaran_okt" id="anggaran_okt" value="<?php echo $ang_oktober ?>" class="form-control" onChange="total_ang('okt',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[11])){ echo "readonly"; } ?> name="anggaran_nov" id="anggaran_nov" value="<?php echo $ang_november ?>" class="form-control" onChange="total_ang('nov',this.value)">
		...
		<td> <input type="text" <?php if(!empty($bulan[12])){ echo "readonly"; } ?> name="anggaran_des" id="anggaran_des" value="<?php echo $ang_desember ?>" class="form-control" onChange="total_ang('des',this.value)">
