<form method="post" id="form" >
	...
	<table class="table table-sm table-bordered table-hover table-striped" id="dt-basic-example" >
		...
		<td> <input type="text" name="nominal_kontrak_jan" id="nominal_kontrak_jan" value="<?php echo $nominal_kontrak_januari ?>" class="form-control" onKeyup="total_nominal('jan',this.value)">
		     <input type="hidden" name="nominal_kontrak_jan_temp" id="nominal_kontrak_jan_temp" value="<?php echo $nominal_kontrak_januari ?>" ></td>
		<td> <input type="text" name="nomor_jan" id="nomor_jan" value="<?php echo $nomor_januari ?>" class="form-control" ></td>
		<td> <input type="date" name="tgl_jan" id="tgl_jan" value="<?php echo $tgl_januari ?>" class="form-control" ></td>
		...
		<td> <textarea type="text" name="ket_jan" id="ket_jan"  class="form-control" ><?php echo $ket_januari ?></textarea></td>
		</tr>
		<tr>
		<td>Februari</td>
		<td> <input type="text" name="tarik_feb" id="tarik_feb" value="<?php echo $februari ?>" class="form-control" readonly></td>
		<td> <input type="text" name="nominal_kontrak_feb" id="nominal_kontrak_feb" value="<?php echo $nominal_kontrak_februari ?>" class="form-control" onKeyup="total_nominal('feb',this.value)">
		     <input type="hidden" name="nominal_kontrak_feb_temp" id="nominal_kontrak_feb_temp" value="<?php echo $nominal_kontrak_februari ?>" ></td>
		<td> <input type="text" name="nomor_feb" id="nomor_feb" value="<?php echo $nomor_februari ?>" class="form-control" ></td>
		<td> <input type="date" name="tgl_feb" id="tgl_feb" value="<?php echo $tgl_februari ?>" class="form-control" ></td>
		...
		<td> <textarea type="text" name="ket_feb" id="ket_feb"  class="form-control" ><?php echo $ket_februari ?></textarea></td>
		</tr>
		<tr>
		<td>Maret</td>
		<td> <input type="text" name="tarik_mar" id="tarik_mar" value="<?php echo $maret ?>" class="form-control" readonly></td>
		<td> <input type="text" name="nominal_kontrak_mar" id="nominal_kontrak_mar" value="<?php echo $nominal_kontrak_maret ?>" class="form-control" onKeyup="total_nominal('mar',this.value)">
		     <input type="hidden" name="nominal_kontrak_mar_temp" id="nominal_kontrak_mar_temp" value="<?php echo $nominal_kontrak_maret ?>" ></td>
		<td> <input type="text" name="nomor_mar" id="nomor_mar" value="<?php echo $nomor_maret ?>" class="form-control" ></td>
		<td> <input type="date" name="tgl_mar" id="tgl_mar" value="<?php echo $tgl_maret ?>" class="form-control" ></td>
		...
		<td> <textarea type="text" name="ket_mar" id="ket_mar"  class="form-control" ><?php echo $ket_maret ?></textarea></td>
		</tr>
		<tr>
		<td>April</td>
		<td> <input type="text" name="tarik_apr" id="tarik_apr" value="<?php echo $april ?>" class="form-control" readonly></td>
		<td> <input type="text" name="nominal_kontrak_apr" id="nominal_kontrak_apr" value="<?php echo $nominal_kontrak_april ?>" class="form-control" onKeyup="total_nominal('apr',this.value)">
		     <input type="hidden" name="nominal_kontrak_apr_temp" id="nominal_kontrak_apr_temp" value="<?php echo $nominal_kontrak_april ?>" ></td>
		<td> <input type="text" name="nomor_apr" id="nomor_apr" value="<?php echo $nomor_april ?>" class="form-control" ></td>
		<td> <input type="date" name="tgl_apr" id="tgl_apr" value="<?php echo $tgl_april ?>" class="form-control" ></td>
		...
		<td> <textarea type="text" name="ket_apr" id="ket_apr"  class="form-control" ><?php echo $ket_april ?></textarea></td>
		</tr>
		<tr>
		<td>Mei</td>
		<td> <input type="text" name="tarik_mei" id="tarik_mei" value="<?php echo $mei ?>" class="form-control" readonly></td>
		<td> <input type="text" name="nominal_kontrak_mei" id="nominal_kontrak_mei" value="<?php echo $nominal_kontrak_mei ?>" class="form-control" onKeyup="total_nominal('mei',this.value)">
		     <input type="hidden" name="nominal_kontrak_mei_temp" id="nominal_kontrak_mei_temp" value="<?php echo $nominal_kontrak_mei ?>" ></td>
		<td> <input type="text" name="nomor_mei" id="nomor_mei" value="<?php echo $nomor_mei ?>" class="form-control" ></td>
		<td> <input type="date" name="tgl_mei" id="tgl_mei" value="<?php echo $tgl_mei ?>" class="form-control" ></td>
		...
		<td> <textarea type="text" name="ket_mei" id="ket_mei"  class="form-control" ><?php echo $ket_mei ?></textarea></td>
		</tr>
		<tr>
		<td>Juni</td>
		<td> <input type="text" name="tarik_jun" id="tarik_jun" value="<?php echo $juni ?>" class="form-control" readonly></td>
		<td> <input type="text" name="nominal_kontrak_jun" id="nominal_kontrak_jun" value="<?php echo $nominal_kontrak_juni ?>" class="form-control" onKeyup="total_nominal('jun',this.value)">
		     <input type="hidden" name="nominal_kontrak_jun_temp" id="nominal_kontrak_jun_temp" value="<?php echo $nominal_kontrak_juni ?>" ></td>
		<td> <input type="text" name="nomor_jun" id="nomor_jun" value="<?php echo $nomor_juni ?>" class="form-control" ></td>
		<td> <input type="date" name="tgl_jun" id="tgl_jun" value="<?php echo $tgl_juni ?>" class="form-control" ></td>
		...
		<td> <textarea type="text" name="ket_jun" id="ket_jun"  class="form-control" ><?php echo $ket_juni ?></textarea></td>
		</tr>
		<tr>
		<td>Juli</td>
		<td> <input type="text" name="tarik_jul" id="tarik_jul" value="<?php echo $juli ?>" class="form-control" readonly></td>
		<td> <input type="text" name="nominal_kontrak_jul" id="nominal_kontrak_jul" value="<?php echo $nominal_kontrak_juli ?>" class="form-control" onKeyup="total_nominal('jul',this.value)">
		     <input type="hidden" name="nominal_kontrak_jul_temp" id="nominal_kontrak_jul_temp" value="<?php echo $nominal_kontrak_juli ?>" ></td>
		<td> <input type="text" name="nomor_jul" id="nomor_jul" value="<?php echo $nomor_juli ?>" class="form-control" ></td>
		<td> <input type="date" name="tgl_jul" id="tgl_jul" value="<?php echo $tgl_juli ?>" class="form-control" ></td>
		...
		<td> <textarea type="text" name="ket_jul" id="ket_jul"  class="form-control" ><?php echo $ket_juli ?></textarea></td>
		</tr>
		<tr>
		<td>Agustus</td>
		<td> <input type="text" name="tarik_agu" id="tarik_agu" value="<?php echo $agustus ?>" class="form-control" readonly></td>
		<td> <input type="text" name="nominal_kontrak_agu" id="nominal_kontrak_agu" value="<?php echo $nominal_kontrak_agustus ?>" class="form-control" onKeyup="total_nominal('agu',this.value)">
		     <input type="hidden" name="nominal_kontrak_agu_temp" id="nominal_kontrak_agu_temp" value="<?php echo $nominal_kontrak_agustus ?>" ></td>
		<td> <input type="text" name="nomor_agu" id="nomor_agu" value="<?php echo $nomor_agustus ?>" class="form-control" ></td>
		<td> <input type="date" name="tgl_agu" id="tgl_agu" value="<?php echo $tgl_agustus ?>" class="form-control" ></td>
		...
		<td> <textarea type="text" name="ket_agu" id="ket_agu"  class="form-control" ><?php echo $ket_agustus ?></textarea></td>
		</tr>
		<tr>
		<td>September</td>
		<td> <input type="text" name="tarik_sep" id="tarik_sep" value="<?php echo $september ?>" class="form-control" readonly></td>
		<td> <input type="text" name="nominal_kontrak_sep" id="nominal_kontrak_sep" value="<?php echo $nominal_kontrak_september  ?>" class="form-control" onKeyup="total_nominal('sep',this.value)">
		     <input type="hidden" name="nominal_kontrak_sep_temp" id="nominal_kontrak_sep_temp" value="<?php echo $nominal_kontrak_september ?>" ></td>
		<td> <input type="text" name="nomor_sep" id="nomor_sep" value="<?php echo $nomor_september ?>" class="form-control" ></td>
		<td> <input type="date" name="tgl_sep" id="tgl_sep" value="<?php echo $tgl_september ?>" class="form-control" ></td>
		...
		<td> <textarea type="text" name="ket_sep" id="ket_sep"  class="form-control" ><?php echo $ket_september ?></textarea></td>
		</tr>
		<tr>
		<td>Oktober</td>
		<td> <input type="text" name="tarik_okt" id="tarik_okt" value="<?php echo $oktober ?>" class="form-control" readonly></td>
		<td> <input type="text" name="nominal_kontrak_okt" id="nominal_kontrak_okt" value="<?php echo $nominal_kontrak_oktober ?>" class="form-control" onKeyup="total_nominal('okt',this.value)">
		     <input type="hidden" name="nominal_kontrak_okt_temp" id="nominal_kontrak_okt_temp" value="<?php echo $nominal_kontrak_oktober ?>" ></td>
		<td> <input type="text" name="nomor_okt" id="nomor_okt" value="<?php echo $nomor_oktober ?>" class="form-control" ></td>
		<td> <input type="date" name="tgl_okt" id="tgl_okt" value="<?php echo $tgl_oktober ?>" class="form-control" ></td>
		...
		<td> <textarea type="text" name="ket_okt" id="ket_okt"  class="form-control" ><?php echo $ket_oktober ?></textarea></td>
		</tr>
		<tr>
		<td>November</td>
		<td> <input type="text" name="tarik_nov" id="tarik_nov" value="<?php echo $november ?>" class="form-control" readonly></td>
		<td> <input type="text" name="nominal_kontrak_nov" id="nominal_kontrak_nov" value="<?php echo $nominal_kontrak_november ?>" class="form-control" onKeyup="total_nominal('nov',this.value)">
		     <input type="hidden" name="nominal_kontrak_nov_temp" id="nominal_kontrak_nov_temp" value="<?php echo $nominal_kontrak_november ?>" ></td>
		<td> <input type="text" name="nomor_nov" id="nomor_nov" value="<?php echo $nomor_november ?>" class="form-control" ></td>
		<td> <input type="date" name="tgl_nov" id="tgl_nov" value="<?php echo $tgl_november ?>" class="form-control" ></td>
		...
		<td> <textarea type="text" name="ket_nov" id="ket_nov"  class="form-control" ><?php echo $ket_november ?></textarea></td>
		</tr>
		<tr>
		<td>Desember</td>
		<td> <input type="text" name="tarik_des" id="tarik_des" value="<?php echo $desember ?>" class="form-control" readonly></td>
		<td> <input type="text" name="nominal_kontrak_des" id="nominal_kontrak_des" value="<?php echo $nominal_kontrak_desember ?>" class="form-control" onKeyup="total_nominal('des',this.value)">
		     <input type="hidden" name="nominal_kontrak_des_temp" id="nominal_kontrak_des_temp" value="<?php echo $nominal_kontrak_desember ?>" ></td>
		<td> <input type="text" name="nomor_des" id="nomor_des" value="<?php echo $nomor_desember ?>" class="form-control" ></td>
		<td> <input type="date" name="tgl_des" id="tgl_des" value="<?php echo $tgl_desember ?>" class="form-control" ></td>
		...
		<td> <textarea type="text" name="ket_des" id="ket_des"  class="form-control" ><?php echo $ket_desember ?></textarea></td>
		</tr>
		<tr>
		<td>Total</td>
