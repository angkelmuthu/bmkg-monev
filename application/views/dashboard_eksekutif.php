                                            ...
                                            <div class="row">
                                                <div class="col-xl-4">
                                                    <div class="panel-content">
                                                        <h4>Realisasi BMKG</h4>
                                                        <div id="bmkg" style="width:100%; height:200px;"></div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4">
                                                    <div class="panel-content">
                                                        <h4>Realisasi DUKMAN</h4>
                                                        <div id="dukman" style="width:100%; height:200px;"></div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4">
                                                    <div class="panel-container show">
                                                        <div class="panel-content">
                                                            <h4>Realisasi PMKG</h4>
                                                            <div id="pmkg" style="width:100%; height:200px;"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="panel-container show">
                                            <div class="panel-content">
                                                <div id="barlineCombine">
                                                    <canvas style="width:100%; height:185px;"></canvas>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
