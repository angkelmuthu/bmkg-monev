        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#dt-basic-example").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "ref_satker/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_satker",
                            "orderable": false
                        },{"data": "kode_satker"},{"data": "nama_satker"},{"data": "kode_jenis_satker"},{"data": "kode_parent_satker"},{"data": "alamat"},{"data": "no_tlpn"},{"data": "kode_dept"},{"data": "kode_unit_kerja"},{"data": "aktif"},
                        {
                            "data" : "action",
                            "orderable": false,
