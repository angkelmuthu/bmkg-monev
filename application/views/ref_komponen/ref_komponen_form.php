                        ...
                        <form action="<?php echo $action; ?>" method="post">
                            ...
                            <table class='table table-striped'>
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" name="kode_komponen" id="kode_komponen" placeholder="Kode Komponen" value="<?php echo $kode_komponen; ?>" required /></td>
                                </tr>
                                <tr>
                                    <td width='200'>Nama Komponen</td>
                                    <td><input type="text" class="form-control" name="nama_komponen" id="nama_komponen" placeholder="Nama Komponen" value="<?php echo $nama_komponen; ?>" required /></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo select2_dinamis('kode_ro', 'ref_output_sub', 'kode_ro', 'nama_ro', $kode_ro, 'aktif="y"', '') ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td></td>
                                    <td><input type="hidden" name="id_komponen" value="<?php echo $id_komponen; ?>" />
                                        <button type="submit" class="btn btn-warning waves-effect waves-themed"><i class="fal fa-save"></i> <?php echo $button ?></button>
                                        <a href="<?php echo site_url('ref_komponen') ?>" class="btn btn-info waves-effect waves-themed"><i class="fal fa-sign-out"></i> Kembali</a>
                                    </td>
                                </tr>
                            </table>
                        </form>
