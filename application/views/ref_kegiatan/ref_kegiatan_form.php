                        ...
                        <form action="<?php echo $action; ?>" method="post">
                            ...
                            <table class='table table-striped'>
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" name="kode_kegiatan" id="kode_kegiatan" placeholder="Kode Kegiatan" value="<?php echo $kode_kegiatan; ?>" required /></td>
                                </tr>
                                <tr>
                                    <td width='200'>Nama Kegiatan</td>
                                    <td><input type="text" class="form-control" name="nama_kegiatan" id="nama_kegiatan" placeholder="Nama Kegiatan" value="<?php echo $nama_kegiatan; ?>" required /></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td></td>
                                    <td><input type="hidden" name="id_kegiatan" value="<?php echo $id_kegiatan; ?>" />
                                        <button type="submit" class="btn btn-warning waves-effect waves-themed"><i class="fal fa-save"></i> <?php echo $button ?></button>
                                        <a href="<?php echo site_url('ref_kegiatan') ?>" class="btn btn-info waves-effect waves-themed"><i class="fal fa-sign-out"></i> Kembali</a>
                                    </td>
                                </tr>
                            </table>
                        </form>
